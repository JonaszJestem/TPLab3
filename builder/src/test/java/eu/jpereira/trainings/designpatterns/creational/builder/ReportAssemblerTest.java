...
public class ReportAssemblerTest {
	...
	public void testAssembleJSONReportBody() {
		...
		JSONReportBody jsonReportBody = new JSONReportBody();

		assembler.setSaleEntry(createDummySaleEntry());
		Report report = assembler.getReport(jsonReportBody);
	...
	public void testAssembleXMLReportBody() {
		...
		assembler.setSaleEntry(createDummySaleEntry());
		Report report = assembler.getReport(xmlReportBody);
	...
	public void testAssembleHTMLReportBody() {
		...
		assembler.setSaleEntry(createDummySaleEntry());
		Report report = assembler.getReport(htmlReportBody);
